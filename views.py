...
def home(request):
    return render(request, 'soundapp/home.html')
...
#     return render(request, 'soundapp/pet_list.html', {'pets': pets, 'form': form})

# def product_detail(request, pk):
#     pet = get_object_or_404(Pet, pk=pk)
#     return render(request, 'soundapp/pet_detail.html', {'pet': pet})
